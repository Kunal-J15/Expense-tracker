...
module.exports.getAllExpenses = (async(req,res,next)=>{
  ...
  module.exports.postExpense = catchAsync(async(req,res,next)=>{
    ...
    let client = await Expense.build({value:parseInt(value) ,description, category});
    await client.save();
    res.send(client)
  })
  ...
  module.exports.updateExpense = catchAsync(async(req,res,next)=>{
    ...
    let client = await Expense.update({value:parseInt(value),description,category},{where:{ id:req.params.id }}); 
    res.send(client);
});
